...
// Adicione este listener para o link também
document.querySelector('.quiz-link')?.addEventListener('click', function(e) {
    e.preventDefault();
    showQuiz();
});

// Mantenha o listener original para o botão
elements.quizBtn.addEventListener('click', showQuiz);
